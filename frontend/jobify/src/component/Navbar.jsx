  ...
  return (
    ...
    <div className='flex justify-between items-center p-5 bg-[#0A1A1A] text-[#f8fdff] border-b-[1px] border-white'>
      <div className='flex gap-[10px] ml-5 items-center'>
       ...
       <Link to='/'> <div className='ml-6 font-semibold transition duration-300 hover:text-[#79ded1]'><h2 className="relative pb-1 after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-0 after:h-[2px] after:bg-blue-400 after:transition-all after:duration-300 group-hover:after:w-full">Home</h2></div></Link>
        ...
        <Link to='/progress'><div className='ml-6 font-semibold transition duration-300 hover:text-[#79ded1]'><h2>My Progress</h2></div></Link>
